...
export default function Loan() {
    ...
    return (
        <div className="bg-white rounded-xl flex flex-col overflow-hidden">
            <h1 className="p-4 py-3 text-xl bg-slate-200 h-full shadow-inner border border-b-0 rounded-t-xl">
            ...
            >
                ...
                <div>
                    <h1 className="mb-3 font-medium">Loan will be used for</h1>
                    ...
                    <div className="grid grid-cols-5 gap-4">
                        {loanTenures.map((tenure, index) => (
                            <button
                                key={index}
                                type="button"
                                onClick={() => handleLoanTenureSelect(tenure)}
                                className={`py-2 px-4 rounded-md border border-gray-300 transition-all duration-200 ${
                ...
                <div className="p-4 bg-gray-50 rounded-md">
                    <fieldset className="border border-gray-300 rounded">
                        <legend className="ml-3 px-1 text-lg">Address</legend>
                        <div className="p-4 flex flex-col gap-4">
                            <div className="flex gap-4">
                ...
                <div className="text-justify">
                    ...
                    <div className="flex gap-2 items-baseline py-2">
                        ...
                        <label htmlFor="consent1">
                            ...
                            provided. This information, as well as that provided
                            by me in the application, will be referred to in
                            connection with this lease and any other
                            relationships we may establish from time to time.
